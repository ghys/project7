      ...
      <f7-row>
        <f7-col width="100" tablet-width="50">
          ...
          <f7-list class="search-list">
            <f7-list-item color="red" link="inbox/" title="Inbox" badge="1" badge-color="red" :footer="objectsFooters.inbox"></f7-list-item>
            <f7-list-item link="things/" title="Things" after="24" badge-color="blue" :footer="objectsFooters.things"></f7-list-item>
            <f7-list-item link="items/" title="Items" after="192" badge-color="blue" :footer="objectsFooters.items"></f7-list-item>
            <f7-list-item link="rules/" title="Rules" after="3" badge-color="blue" :footer="objectsFooters.rules"></f7-list-item>
          </f7-list>
          <f7-block-title>Add-ons</f7-block-title>
          <f7-list class="search-list">
            <f7-list-item v-for="type in addonTypes" :key="type.id" :link="'addons/' + type.id" :title="type.label" :footer="addonsFooters[type.id]"></f7-list-item>
          </f7-list>
        </f7-col>
        <f7-col width="100" tablet-width="50">
          <f7-block-title>System Services</f7-block-title>
          <f7-list class="search-list">
            <f7-list-item v-for="service in systemServices" :key="service.id" :link="'services/' + service.id" :title="service.label"></f7-list-item>
          </f7-list>
          <f7-block-title>Other Services</f7-block-title>
          <f7-list class="search-list">
            <f7-list-item v-for="service in otherServices" :key="service.id" :link="'services/' + service.id" :title="service.label"></f7-list-item>
          </f7-list>
        </f7-col>
      </f7-row>
    </f7-block>
